...
class Model(BenchmarkModel):
    ...
    def __init__(self, test, device, batch_size=None, jit=False, extra_args=[]):
        ...
        self.example_inputs = example_batch['bert_input'].to(self.device_obj)[:self.batch_size], example_batch['segment_label'].to(self.device_obj)[:self.batch_size]
        self.is_next = example_batch['is_next'].to(self.device_obj)[:self.batch_size]
        self.bert_label = example_batch['bert_label'].to(self.device_obj)[:self.batch_size]
        self.model = trainer
